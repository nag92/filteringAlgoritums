...
df = pd.DataFrame.from_csv('/home/nathaniel/Documents/final thesis/0415/15_35_24/usbl_pose.csv', index_col=None)
df2 = pd.DataFrame.from_csv('/home/nathaniel/Documents/final thesis/0415/15_35_24/pose.csv', index_col=None)

my_x = df['field.pose.position.x'].values.tolist()
my_y = df['field.pose.position.y'].values.tolist()
my_z = df2['field.pose.position.z'].values.tolist()
real_z = my_z
...
#ax1.text(-10, 2, unicode(u"\u03B1")+ " =  "  +  str(alpha), fontsize=15)
ax1.text(-10, +6,  "Kept =  "  + str(100* float(outliers)/float(len(t))) + "%", fontsize=15)

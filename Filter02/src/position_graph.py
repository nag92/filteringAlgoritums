...
df = pd.DataFrame.from_csv('/home/nathaniel/data_from_11_20/14_68_23/usbl_pose.csv', index_col=None)
df2 = pd.DataFrame.from_csv('/home/nathaniel/data_from_11_20/14_68_23/pose_only.csv', index_col=None)
...
md_filter = md_filter.md_filter(2, [1.75, 1.6], n, [1, 2])
#md_filter = md_filter.md_filter(2, [1.386, 1.386], n, [1, 2])
# print len(my_z  )

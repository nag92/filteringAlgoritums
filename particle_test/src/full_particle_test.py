...
df = pd.DataFrame.from_csv('/home/nathaniel/KingsPointData/13_06_56/usbl_pose.csv', index_col=None)
...
prop = 2.77
n = 10
model = lambda x,u,t : x + u*t + np.random.normal(0,10,1)
z = lambda x : x 
x = 0
time = [ii for ii in xrange(0,100)]

particle_x = Particle_Filter.Particle_Filter(x,model,z,100,2,np.sqrt(10))
particle_y = Particle_Filter.Particle_Filter(x,model,z,100,2,np.sqrt(10))
